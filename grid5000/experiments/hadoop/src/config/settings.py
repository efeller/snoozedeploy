...
SYSTEM_ROOT_USER_PASSWORD = "mapreduce"
SYSTEM_HADOOP_USER_NAME = "efeller"
SYSTEM_HADOOP_USER_PASSWORD = ""
...
SYSTEM_JAVA_INSTALL_DIR = "/usr/lib/jvm/java-6-sun"
...
HADOOP_MAX_NUMBER_OF_MAP_SLOTS = "15"
...
HADOOP_START_EXAMPLE_BENCHMARK = HADOOP_START_COMMAND + HADOOP_INSTALL_DIR +"/hadoop-" + \
                                 HADOOP_VERSION + "-examples.jar" + WHITESPACE
