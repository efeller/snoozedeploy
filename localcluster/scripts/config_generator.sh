...
generate_bootstrap_config () {
    # config
    sed 's/^control_data_port.*/control_data_port = '$2'/g' "./configs/snooze_node.cfg" > "./tmp/snooze_node_bs_$1.cfg" 
...
generate_group_manager_config () {
    # General settings
    sed 's/^control_data_port.*/control_data_port = '$2'/g' "./configs/snooze_node.cfg" > "./tmp/snooze_node_gm_$1.cfg" 
...
{
    sed 's/^tcp_port.*/tcp_port = \"'$2'\"/g' "./configs/libvirtd.conf" > "./tmp/snooze_libvirtd_$1.conf"
}
